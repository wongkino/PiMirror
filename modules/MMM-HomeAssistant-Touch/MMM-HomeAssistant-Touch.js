Module.register("MMM-HomeAssistant-Touch", {
  ...
  getScripts: function () {
    return [
      ...
      this.file("./UIClasses/Climate.js"),
      this.file("./UIClasses/Scene.js"),
...
function getDom() {
  ...
  wrapper.className = "ha-touch-root";
  wrapper.id = "ha-touch-" + String(this.identifier).replace(/[^a-zA-Z0-9_-]/g, "_");
